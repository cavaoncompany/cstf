        ...
        >
          ...
          <section v-if="currentPage === 1" id="quote-page-1">
            ...
            <div class="progress-bar-wrapper bg-white-column row">
              <div class="invisible page-navigation disabled" role="button" aria-disabled="true" @click="previousPage()">
                <i class="fa fa-chevron-left" /> {{ quote.back }}
              </div>
          ...
          <section v-if="currentPage === 2" id="quote-page-2">
            ...
            <div class="sep has-width w80 accent-bg clearfix" />
            <div class="progress-bar-wrapper bg-white-column row">
              <div class="page-navigation disabled" role="button" aria-disabled="true" @click="previousPage()">
                <i class="fa fa-chevron-left" /> {{ quote.back }}
              </div>
              <div class="progress-wrapper">
                <div class="progress">
          ...
          <section v-if="currentPage === 3" id="quote-page-3">
            ...
            <div class="sep has-width w80 accent-bg clearfix" />
            <div class="progress-bar-wrapper bg-white-column row">
              <div class="page-navigation" @click="previousPage()">
                <i class="fa fa-chevron-left" /> {{ quote.back }}
              </div>
              <div class="progress-wrapper">
                <div class="progress">
            ...
            <article class="bg-white-column questionnaire">
              ...
              <article class="with-border">
                ...
                <article v-if="noDAApprovalSelected === true" class="sub-quote-article">
                  ...
                  <p v-if="noDAApprovalIsEmpty === true" class="warning-message">
                    {{ quote.noDAApproval.noReason }}
                  </p>
                </article>
              </article>
              <h3>
              ...
              <article class="with-border">
                ...
                <article v-if="architecturalPlansSelected" class="sub-article-dashed">
                  ...
                  <input
                    ...
                    @blur="sendWarning('architectural')"
                  >
                  <label for="architecturalPlans">
                    <i class="fa fa-upload" />
                    {{ quote.architecturalPlan.uploadButton }}
                  </label>
                  <p v-if="architecturalPlanIsEmpty === true">
                    {{ quote.architecturalPlan.uploadMissing }}
                  </p>
                </article>
              </article>
              ...
              <article class="with-border" :class="{'greyed-out': engineeringPlansEnabled === false}">
                ...
                <article v-if="engineeringPlansSelected" class="sub-article-dashed">
                  ...
                  <p v-if="engineeringPlanIsEmpty === true" class="warning-message">
                    {{ quote.engineeringPlan.uploadMissing }}
                  </p>
                </article>
              </article>
          ...
          <section v-if="currentPage === 4" id="quote-page-4">
            ...
            <div class="progress-bar-wrapper bg-white-column row">
              ...
              <div class="page-navigation invisible disabled" role="button" aria-disabled="true" @click="nextPage()">
                {{ quote.next }} <i class="fa fa-chevron-right" />
              </div>
            </div>
            <article class="bg-white-column questionnaire">
              ...
              <article class="with-border">
                <div v-for="(detailquote, index) in quote.quoteFor.type" :key="index">
                  <input
                    :id="'quoteFor' + index"
                    v-model="quoteFor"
                    type="radio"
                    ...
                    :value="detailquote"
                  >
                  <label :for="'quoteFor' + index">{{ detailquote }}</label><br>
                </div>
              </article>
              <h3>
...
export default {
  ...
  data() {
    return {
      ...
      noDAApproval: '',
      noDAApprovalIsEmpty: true,
      architecturalPlans: '',
      architecturalPlansSelected: false,
      architecturalPlan: '',
      architecturalPlanPath: '',
      architecturalFile: '',
      architecturalPlanIsEmpty: false,
      engineeringPlans: '',
      engineeringPlan: '',
      engineeringPlanPath: '',
  ...
  watch: {
    ...
    noDAApproval: function () {
      if (this.noDAApproval !== '') {
        this.noDAApprovalIsEmpty = false
      } else {
        this.noDAApprovalIsEmpty = true
      }
    },
    ...
    architecturalPlan: function () {
      if (this.DAApproval === 'Yes' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'Yes' && this.engineeringPlan !== '' && this.structuralPlans !== '') {
        this.page4enabled = true
        this.architecturalPlanIsEmpty = false
      } else if (this.DAApproval === 'No' && this.noDAApproval !== '' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'Yes' && this.engineeringPlan !== '' && this.structuralPlans !== '') {
        this.page4enabled = true
        this.architecturalPlanIsEmpty = false
      } else if (this.DAApproval === 'Yes' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'No') {
        ...
        this.page4enabled = true
        this.architecturalPlanIsEmpty = false
      } else if (this.architecturalPlan !== '') {
        this.architecturalPlanIsEmpty = false
        this.page4enabled = false
      } else {
        this.page4enabled = false
    ...
    engineeringPlan: function () {
      if (this.DAApproval === 'Yes' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'Yes' && this.engineeringPlan !== '' && this.structuralPlans !== '') {
        this.page4enabled = true
        this.engineeringPlanIsEmpty = false
      } else if (this.DAApproval === 'No' && this.noDAApproval !== '' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'Yes' && this.engineeringPlan !== '' && this.structuralPlans !== '') {
        this.page4enabled = true
        this.engineeringPlanIsEmpty = false
      } else if (this.DAApproval === 'Yes' && this.architecturalPlans === 'Yes' && this.architecturalPlan !== '' && this.engineeringPlans === 'No') {
  ...
  methods: {
    ...
    sendWarning: function (field) {
      if (field === 'architectural') {
        if (this.architecturalPlan === '') {
          this.architecturalPlanIsEmpty = true
        } else {
          this.architecturalPlanIsEmpty = false
        }
      } else if (field === 'engineering') {
        if (this.engineeringPlans === 'Yes' && this.engineeringPlan === '') {
          this.engineeringPlanIsEmpty = true
        } else {
          this.engineeringPlanIsEmpty = false
        }
      }
