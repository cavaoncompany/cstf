                ...
                <nav id="main-nav" class="main-nav">
                  <ul id="menu-primary-menu" class="menu">
                    ...
                    <!-- <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item">
                          <a href="page-testimonial.html">PAGE TESTIMONIAL</a>
                        </li>
                        <li class="menu-item">
                          <a href="page-pricing.html">PAGE PRICING</a>
                        </li>
                      </ul>
                    </li>
                    <li class="menu-item menu-item-has-children">
                ...
                <div class="widget widget_text">
                  <div class="textwidget">
                    ...
                    <p class="margin-bottom-15">
                      We have over 15 years of experien able to help you 24 hours a day.
                    </p>
                    ...
                    <ul>
                      ...
                      <li class="margin-top-7">
                        <div class="inner">
                          <span class=" font-size-14 fa fa-envelope" />
                  ...
                  <ul class="lastest-posts data-effect clearfix">
                    <li class="clearfix">
                      <div class="thumb data-effect-item has-effect-icon">
                        ...
                        <div class="elm-link">
                          <a href="page-blog-single.html" class="icon-2" />
                        </div>
                      </div>
                      <div class="text">
          ...
          <div id="bottom-bar-inner" class="container">
            <div class="bottom-bar-inner-wrap">
              <div class="bottom-bar-content">
                <div id="copyright">
                  © <span class="text">Construction Template. Design <a href="#" class="text-accent">by @Niche_Theme</a></span>
                </div>
